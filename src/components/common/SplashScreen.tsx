...
export const SplashScreen: React.FC = () => {
  return (
    <div className="fixed inset-0 z-50 bg-warm-bg flex flex-col items-center justify-center p-6 text-center animate-fade-in select-none">
      ...
      <div className="relative z-10 p-6 sm:p-8 bg-white rounded-3xl border-2 border-brand-200 shadow-2xl animate-bounce-subtle flex flex-col items-center justify-center">
        <Logo size="lg" className="justify-center" showLocation={true} />
      </div>

      {/* Enhanced Dual Animated Loading Spinner */}
      <div className="relative z-10 mt-10 flex flex-col items-center gap-3.5">
        <div className="relative w-12 h-12 flex items-center justify-center">
          ...
          <div className="absolute w-6 h-6 rounded-full border-2 border-amber-500 border-b-transparent animate-spin-slow" />
        </div>
